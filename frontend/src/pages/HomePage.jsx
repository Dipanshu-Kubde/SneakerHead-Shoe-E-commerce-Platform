...
// Dummy product sliders data - you can replace with your real data
      ...
      <section className="promo-section">
        <div className="promo-block">
          ...
          <div>
            ...
            <button onClick={() => navigate("/?category=basketball")}>Shop Now</button>
          </div>
        </div>
        <div className="promo-block">
          ...
          <div>
            <h3>Shop Running</h3>
            <button onClick={() => navigate("/?category=running")}>Shop Now</button>
          </div>
        </div>
      </section>
